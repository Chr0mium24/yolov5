...
print(f"背景偏见检测率: {results['bias_detection_rate']:.2%}")
```
...
|------|------|---------|--------|-------------|------|
| YOLOv5x | 基线 | 0.85 | 86.7M | 45 | 教师模型 |
| YOLOv5n | 原版 | 0.78 | 1.9M | 8 | 标准轻量模型 |
| YOLOv5n | +Label Smoothing | 0.82 | 1.9M | 8 | 细粒度分类优化 |
| YOLOv5n | +背景偏见缓解 | 0.84 | 1.9M | 8 | 消除背景偏见 |
| YOLOv5n | +助教蒸馏 | 0.86 | 1.9M | 8 | 知识传递 |
| YOLOv5n | **完整优化** | **0.87** | 1.9M | 8 | **超越教师** |
